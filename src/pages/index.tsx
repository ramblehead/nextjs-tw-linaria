...
import { LinariaButton } from '~/components/view/linaria-button';
...
const Home: NextPage = () => {
  return (
    ...
    >
      <div
        className="z-10 w-full max-w-5xl items-center justify-between
      ...
      >
        <p
          ...
          lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4
          lg:dark:bg-zinc-800/30"
        >
          Get started by editing&nbsp;
          <code className="font-mono font-bold">src/pages/index.tsx</code>
        </p>
        <LinariaButton>Linaria in app!</LinariaButton>
        <div
          className="fixed bottom-0 left-0 flex h-48 w-full items-end
          justify-center bg-gradient-to-t from-white via-white
          dark:from-black dark:via-black lg:static lg:h-auto
